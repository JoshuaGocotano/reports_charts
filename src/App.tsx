...
export default function App() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center px-3 md:px-8 xl:px-10 py-44 bg-white">
      <div className="grid grid-cols-[2fr,1fr] w-full gap-7 max-w-[1400px]">
